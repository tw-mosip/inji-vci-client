...
class InteractiveAuthorizationHandler {
    suspend fun handle(
        ...
        try {
            ...
            if (jsonResponse["type"] == "openid4vp_presentation") {
                ...
                val presentationAuthorizationRequest = PresentationAuthorizationRequestData(
                    ovpRequest = openIdVpInteractionResponse?.openid4vpRequest
                        ?: throw InteractiveAuthorizationException("openid4vp_request is missing in the response"),
                ...
                return callback.find { callback -> callback.type() == "openid4vp_presentation" }
                    ...
                    ?: throw InteractiveAuthorizationException("No matching callback found for openid4vp_presentation")
            } else {
                throw InteractiveAuthorizationException("Unsupported interaction type: ${jsonResponse["type"]}")
            }
            ...
            throw InteractiveAuthorizationException(ex.message)
        }
    }
}